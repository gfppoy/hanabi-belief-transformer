...
if __name__ == "__main__":
    ...
    # model = get_model(5607, 6, 256, args.N, args.num_heads).to(device)
            ...
            if batch_idx % 2 == 0:
                ...
                while True:
                    ...
                    try:
                        ...
                        # cks  = torch.load("multi_replays/"+candidate.replace("src","ck").replace("trg","ck"))
                        ...
                        # os.remove("multi_replays/"+candidate.replace("src","ck").replace("trg","ck"))
