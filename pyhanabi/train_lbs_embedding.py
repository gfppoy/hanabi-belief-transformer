        ...
        for batch_idx in range(args.epoch_len):
            ...
            if (batch_idx + 1) % print_every == 0:
                ...
                if 0.2*sum(loss_avgs) < best_model_score:
                    ...
                    torch.save(model.state_dict(),"/pyhanabi/saves_while_training/model$_2player_belief_trainedsad6.pth")
            ...
            if (batch_idx + 1) % (save_loss_every) == 0:
                np.save(os.path.join('saves_while_training', 'train_loss_trainedsad6.npy'), np.array(running_losses))
                # for j in range(5):
